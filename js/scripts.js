...
document.getElementById("calc-btn").addEventListener("click", () => {
    ...
    genResults(bmr, weight_input.value)
...
function genResults(bmr, weight) {
    ...
    <div class="results">
        <div class="results-card">
            ...
            <p class="results-p">Калории: ${Math.round(bmr*active_input.value)}</p>
            <p class="results-p">Белки: ${weight*0.8} г. (для обычного человека)  ///  ${weight*1.55} г. (для спортсменов)</p>
